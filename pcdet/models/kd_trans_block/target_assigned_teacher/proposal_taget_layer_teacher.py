...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        targets_dict = {'rois_tea': batch_rois, 'gt_of_rois_tea': batch_gt_of_rois, 'gt_iou_of_rois_tea': batch_roi_ious,
                        'roi_scores_tea': batch_roi_scores, 'roi_labels_tea': batch_roi_labels,
                        'reg_valid_mask_tea': reg_valid_mask,
                        'rcnn_cls_labels_tea': batch_cls_labels}
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        rois = batch_dict['rois_tea']
        roi_scores = batch_dict['roi_scores_tea']
        roi_labels = batch_dict['roi_labels_tea']
