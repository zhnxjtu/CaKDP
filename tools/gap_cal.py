...
def parse_config():
    ...
    parser.add_argument('--criterion_dir', type=str, default='measure_doc', help='specify a directory to save the pruning criterion file')
...
def eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, epoch_id, dist_test=False):
    ...
    # start evaluation
    eval_utils.eval_one_epoch_measurement_plain(
        cfg, args, model, test_loader, epoch_id, logger, dist_test=dist_test,
        result_dir=eval_output_dir, save_to_file=args.save_to_file,
        criterion_file_dir = args.criterion_dir, dataset_name = args.dataset_name
    )
